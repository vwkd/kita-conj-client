...
function Table({ PRS, IMPF, PRSSUBJ, FUT, COND, FUTSUBJ, AOR, OPT, PERF, PLUPERF, PERFSUBJ, AORIMPF, OPTIMPF, PERFIMPF, PLUPERFIMPF, PERFSUBJIMPF, IMPAFF, IMPAFFIMPF, IMPPRB1, IMPPRB1IMPF, IMPPRB2, INF, INFIMPF }) {
  return (
